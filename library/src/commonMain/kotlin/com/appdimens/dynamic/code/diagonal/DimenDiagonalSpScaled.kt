...
class DiagonalSp private constructor(
    ...
    private fun resolvePxInternal(
        ...
        return valueToUse.toDynamicDiagonalSpPx(
            ctx,
            finalQualifier,
            finalFontScale,
    ...
    fun dgssp(ctx: DimenCallContext): Float = resolvePx(ctx, DpQualifier.SMALL_WIDTH)
    fun dghsp(ctx: DimenCallContext): Float = resolvePx(ctx, DpQualifier.HEIGHT)
    fun dgwsp(ctx: DimenCallContext): Float = resolvePx(ctx, DpQualifier.WIDTH)
