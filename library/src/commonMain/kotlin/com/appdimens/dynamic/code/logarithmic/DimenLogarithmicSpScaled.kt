...
class LogarithmicSp private constructor(
    ...
    private fun resolvePxInternal(
        ...
        return valueToUse.toDynamicLogarithmicSpPx(
            ctx,
            finalQualifier,
            finalFontScale,
    ...
    fun logssp(ctx: DimenCallContext): Float = resolvePx(ctx, DpQualifier.SMALL_WIDTH)
    fun loghsp(ctx: DimenCallContext): Float = resolvePx(ctx, DpQualifier.HEIGHT)
    fun logwsp(ctx: DimenCallContext): Float = resolvePx(ctx, DpQualifier.WIDTH)
