...
object DimenDiagonalSp {
     ...
     */
    @JvmStatic
    fun dgssp(ctx: DimenCallContext, value: Int): Float = value.dgssp(ctx)
     ...
     */
    @JvmStatic
    fun dghsp(ctx: DimenCallContext, value: Int): Float = value.dghsp(ctx)
     ...
     */
    @JvmStatic
    fun dgwsp(ctx: DimenCallContext, value: Int): Float = value.dgwsp(ctx)
    ...
    ): Float = value.toDynamicDiagonalSpPx(ctx, qualifier, fontScale, inverter, ignoreMultiWindows, applyAspectRatio, customSensitivityK)
    ...
    fun getDimensionInSp(
        ...
        applyAspectRatio: Boolean = false,
        customSensitivityK: Float? = null
    ): Float = value.toDynamicDiagonalSp(ctx, qualifier, fontScale, inverter, ignoreMultiWindows, applyAspectRatio, customSensitivityK)
