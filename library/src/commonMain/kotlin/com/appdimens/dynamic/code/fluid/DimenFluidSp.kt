...
object DimenFluidSp {
     ...
     */
    @JvmStatic
    fun fssp(ctx: DimenCallContext, value: Int): Float = value.fssp(ctx)
     ...
     */
    @JvmStatic
    fun fhsp(ctx: DimenCallContext, value: Int): Float = value.fhsp(ctx)
     ...
     */
    @JvmStatic
    fun fwsp(ctx: DimenCallContext, value: Int): Float = value.fwsp(ctx)
    ...
    ): Float = value.toDynamicFluidSpPx(ctx, qualifier, fontScale, inverter, ignoreMultiWindows, applyAspectRatio, customSensitivityK)
    ...
    fun getDimensionInSp(
        ...
        applyAspectRatio: Boolean = false,
        customSensitivityK: Float? = null
    ): Float = value.toDynamicFluidSp(ctx, qualifier, fontScale, inverter, ignoreMultiWindows, applyAspectRatio, customSensitivityK)
