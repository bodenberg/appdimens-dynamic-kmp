...
object DimenInterpolatedSp {
     ...
     */
    @JvmStatic
    fun issp(ctx: DimenCallContext, value: Int): Float = value.issp(ctx)
     ...
     */
    @JvmStatic
    fun ihsp(ctx: DimenCallContext, value: Int): Float = value.ihsp(ctx)
     ...
     */
    @JvmStatic
    fun iwsp(ctx: DimenCallContext, value: Int): Float = value.iwsp(ctx)
    ...
    ): Float = value.toDynamicInterpolatedSpPx(ctx, qualifier, fontScale, inverter, ignoreMultiWindows, applyAspectRatio, customSensitivityK)
    ...
    fun getDimensionInSp(
        ...
        applyAspectRatio: Boolean = false,
        customSensitivityK: Float? = null
    ): Float = value.toDynamicInterpolatedSp(ctx, qualifier, fontScale, inverter, ignoreMultiWindows, applyAspectRatio, customSensitivityK)
