...
object DimenLogarithmicSp {
     ...
     */
    @JvmStatic
    fun logssp(ctx: DimenCallContext, value: Int): Float = value.logssp(ctx)
     ...
     */
    @JvmStatic
    fun loghsp(ctx: DimenCallContext, value: Int): Float = value.loghsp(ctx)
     ...
     */
    @JvmStatic
    fun logwsp(ctx: DimenCallContext, value: Int): Float = value.logwsp(ctx)
    ...
    ): Float = value.toDynamicLogarithmicSpPx(ctx, qualifier, fontScale, inverter, ignoreMultiWindows, applyAspectRatio, customSensitivityK)
    ...
    fun getDimensionInSp(
        ...
        applyAspectRatio: Boolean = false,
        customSensitivityK: Float? = null
    ): Float = value.toDynamicLogarithmicSp(ctx, qualifier, fontScale, inverter, ignoreMultiWindows, applyAspectRatio, customSensitivityK)
