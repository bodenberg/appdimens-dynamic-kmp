...
object DimenPowerSp {
     ...
     */
    @JvmStatic
    fun pwssp(ctx: DimenCallContext, value: Int): Float = value.pwssp(ctx)
     ...
     */
    @JvmStatic
    fun pwhsp(ctx: DimenCallContext, value: Int): Float = value.pwhsp(ctx)
     ...
     */
    @JvmStatic
    fun pwwsp(ctx: DimenCallContext, value: Int): Float = value.pwwsp(ctx)
    ...
    ): Float = value.toDynamicPowerSpPx(ctx, qualifier, fontScale, inverter, ignoreMultiWindows, applyAspectRatio, customSensitivityK)
    ...
    fun getDimensionInSp(
        ...
        applyAspectRatio: Boolean = false,
        customSensitivityK: Float? = null
    ): Float = value.toDynamicPowerSp(ctx, qualifier, fontScale, inverter, ignoreMultiWindows, applyAspectRatio, customSensitivityK)
