...
object DimenPerimeterSp {
     ...
     */
    @JvmStatic
    fun prssp(ctx: DimenCallContext, value: Int): Float = value.prssp(ctx)
     ...
     */
    @JvmStatic
    fun prhsp(ctx: DimenCallContext, value: Int): Float = value.prhsp(ctx)
     ...
     */
    @JvmStatic
    fun prwsp(ctx: DimenCallContext, value: Int): Float = value.prwsp(ctx)
    ...
    ): Float = value.toDynamicPerimeterSpPx(ctx, qualifier, fontScale, inverter, ignoreMultiWindows, applyAspectRatio, customSensitivityK)
    ...
    fun getDimensionInSp(
        ...
        applyAspectRatio: Boolean = false,
        customSensitivityK: Float? = null
    ): Float = value.toDynamicPerimeterSp(ctx, qualifier, fontScale, inverter, ignoreMultiWindows, applyAspectRatio, customSensitivityK)
