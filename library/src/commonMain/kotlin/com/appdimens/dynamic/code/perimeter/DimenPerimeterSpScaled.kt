...
class PerimeterSp private constructor(
    ...
    private fun resolvePxInternal(
        ...
        return valueToUse.toDynamicPerimeterSpPx(
            ctx,
            finalQualifier,
            finalFontScale,
    ...
    fun prssp(ctx: DimenCallContext): Float = resolvePx(ctx, DpQualifier.SMALL_WIDTH)
    fun prhsp(ctx: DimenCallContext): Float = resolvePx(ctx, DpQualifier.HEIGHT)
    fun prwsp(ctx: DimenCallContext): Float = resolvePx(ctx, DpQualifier.WIDTH)
