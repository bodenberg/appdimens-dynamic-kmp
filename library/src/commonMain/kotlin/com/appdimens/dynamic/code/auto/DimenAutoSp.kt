...
object DimenAutoSp {
     ...
     */
    @JvmStatic
    fun assp(ctx: DimenCallContext, value: Int): Float = value.assp(ctx)
     ...
     */
    @JvmStatic
    fun ahsp(ctx: DimenCallContext, value: Int): Float = value.ahsp(ctx)
     ...
     */
    @JvmStatic
    fun awsp(ctx: DimenCallContext, value: Int): Float = value.awsp(ctx)
    ...
    ): Float = value.toDynamicAutoSpPx(ctx, qualifier, fontScale, inverter, ignoreMultiWindows, applyAspectRatio, customSensitivityK)
    ...
    fun getDimensionInSp(
        ...
        applyAspectRatio: Boolean = false,
        customSensitivityK: Float? = null
    ): Float = value.toDynamicAutoSp(ctx, qualifier, fontScale, inverter, ignoreMultiWindows, applyAspectRatio, customSensitivityK)
