...
class InterpolatedSp private constructor(
    ...
    fun issp(ctx: DimenCallContext): Float = resolvePx(ctx, DpQualifier.SMALL_WIDTH)
    fun ihsp(ctx: DimenCallContext): Float = resolvePx(ctx, DpQualifier.HEIGHT)
    fun iwsp(ctx: DimenCallContext): Float = resolvePx(ctx, DpQualifier.WIDTH)
