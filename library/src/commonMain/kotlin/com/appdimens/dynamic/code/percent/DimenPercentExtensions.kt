...
fun Number.psdpRotate(
    ...
    return if (isTargetOrientation) {
        rotationValue.toDynamicPercentPx(ctx, finalQualifierResolver, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    } else {
        this.toDynamicPercentPx(ctx, DpQualifier.SMALL_WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    }
}
...
fun Number.phdpRotate(
    ...
    return if (isTargetOrientation) {
        ...
        this.toDynamicPercentPx(ctx, DpQualifier.HEIGHT, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    }
}
...
fun Number.pwdpRotate(
    ...
    return if (isTargetOrientation) {
        ...
        this.toDynamicPercentPx(ctx, DpQualifier.WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    }
}
...
fun Number.psdpMode(
    ...
    return if (currentUiModeType == uiModeType) {
        modeValue.toDynamicPercentPx(ctx, finalQualifierResolver ?: DpQualifier.SMALL_WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    } else {
        this.toDynamicPercentPx(ctx, DpQualifier.SMALL_WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    }
}
...
fun Number.phdpMode(
    ...
    return if (currentUiModeType == uiModeType) {
        modeValue.toDynamicPercentPx(ctx, finalQualifierResolver ?: DpQualifier.HEIGHT, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    } else {
        this.toDynamicPercentPx(ctx, DpQualifier.HEIGHT, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    }
}
...
fun Number.pwdpMode(
    ...
    val currentUiModeType = ctx.currentUiMode()
    return if (currentUiModeType == uiModeType) {
        modeValue.toDynamicPercentPx(ctx, finalQualifierResolver ?: DpQualifier.WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    } else {
        this.toDynamicPercentPx(ctx, DpQualifier.WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    }
}
 ...
 */
fun Number.psdp(ctx: DimenCallContext): Float = this.toDynamicPercentPx(ctx, DpQualifier.SMALL_WIDTH)
fun Number.psdpa(ctx: DimenCallContext): Float = this.toDynamicPercentPx(ctx, DpQualifier.SMALL_WIDTH, applyAspectRatio = true)
fun Number.psdpi(ctx: DimenCallContext): Float = this.toDynamicPercentPx(ctx, DpQualifier.SMALL_WIDTH, ignoreMultiWindows = true)
fun Number.psdpia(ctx: DimenCallContext): Float = this.toDynamicPercentPx(ctx, DpQualifier.SMALL_WIDTH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.psdpPh(ctx: DimenCallContext): Float = this.toDynamicPercentPx(ctx, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PH)
fun Number.psdpPha(ctx: DimenCallContext): Float = this.toDynamicPercentPx(ctx, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PH, applyAspectRatio = true)
fun Number.psdpPhi(ctx: DimenCallContext): Float = this.toDynamicPercentPx(ctx, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PH, ignoreMultiWindows = true)
fun Number.psdpPhia(ctx: DimenCallContext): Float = this.toDynamicPercentPx(ctx, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.psdpLh(ctx: DimenCallContext): Float = this.toDynamicPercentPx(ctx, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LH)
fun Number.psdpLha(ctx: DimenCallContext): Float = this.toDynamicPercentPx(ctx, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LH, applyAspectRatio = true)
fun Number.psdpLhi(ctx: DimenCallContext): Float = this.toDynamicPercentPx(ctx, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LH, ignoreMultiWindows = true)
fun Number.psdpLhia(ctx: DimenCallContext): Float = this.toDynamicPercentPx(ctx, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.psdpPw(ctx: DimenCallContext): Float = this.toDynamicPercentPx(ctx, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PW)
fun Number.psdpPwa(ctx: DimenCallContext): Float = this.toDynamicPercentPx(ctx, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PW, applyAspectRatio = true)
fun Number.psdpPwi(ctx: DimenCallContext): Float = this.toDynamicPercentPx(ctx, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PW, ignoreMultiWindows = true)
fun Number.psdpPwia(ctx: DimenCallContext): Float = this.toDynamicPercentPx(ctx, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PW, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.psdpLw(ctx: DimenCallContext): Float = this.toDynamicPercentPx(ctx, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LW)
fun Number.psdpLwa(ctx: DimenCallContext): Float = this.toDynamicPercentPx(ctx, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LW, applyAspectRatio = true)
fun Number.psdpLwi(ctx: DimenCallContext): Float = this.toDynamicPercentPx(ctx, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LW, ignoreMultiWindows = true)
fun Number.psdpLwia(ctx: DimenCallContext): Float = this.toDynamicPercentPx(ctx, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LW, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.phdp(ctx: DimenCallContext): Float = this.toDynamicPercentPx(ctx, DpQualifier.HEIGHT)
fun Number.phdpa(ctx: DimenCallContext): Float = this.toDynamicPercentPx(ctx, DpQualifier.HEIGHT, applyAspectRatio = true)
fun Number.phdpi(ctx: DimenCallContext): Float = this.toDynamicPercentPx(ctx, DpQualifier.HEIGHT, ignoreMultiWindows = true)
fun Number.phdpia(ctx: DimenCallContext): Float = this.toDynamicPercentPx(ctx, DpQualifier.HEIGHT, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.phdpLw(ctx: DimenCallContext): Float = this.toDynamicPercentPx(ctx, DpQualifier.HEIGHT, Inverter.PH_TO_LW)
fun Number.phdpLwa(ctx: DimenCallContext): Float = this.toDynamicPercentPx(ctx, DpQualifier.HEIGHT, Inverter.PH_TO_LW, applyAspectRatio = true)
fun Number.phdpLwi(ctx: DimenCallContext): Float = this.toDynamicPercentPx(ctx, DpQualifier.HEIGHT, Inverter.PH_TO_LW, ignoreMultiWindows = true)
fun Number.phdpLwia(ctx: DimenCallContext): Float = this.toDynamicPercentPx(ctx, DpQualifier.HEIGHT, Inverter.PH_TO_LW, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.phdpPw(ctx: DimenCallContext): Float = this.toDynamicPercentPx(ctx, DpQualifier.HEIGHT, Inverter.LH_TO_PW)
fun Number.phdpPwa(ctx: DimenCallContext): Float = this.toDynamicPercentPx(ctx, DpQualifier.HEIGHT, Inverter.LH_TO_PW, applyAspectRatio = true)
fun Number.phdpPwi(ctx: DimenCallContext): Float = this.toDynamicPercentPx(ctx, DpQualifier.HEIGHT, Inverter.LH_TO_PW, ignoreMultiWindows = true)
fun Number.phdpPwia(ctx: DimenCallContext): Float = this.toDynamicPercentPx(ctx, DpQualifier.HEIGHT, Inverter.LH_TO_PW, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.pwdp(ctx: DimenCallContext): Float = this.toDynamicPercentPx(ctx, DpQualifier.WIDTH)
fun Number.pwdpa(ctx: DimenCallContext): Float = this.toDynamicPercentPx(ctx, DpQualifier.WIDTH, applyAspectRatio = true)
fun Number.pwdpi(ctx: DimenCallContext): Float = this.toDynamicPercentPx(ctx, DpQualifier.WIDTH, ignoreMultiWindows = true)
fun Number.pwdpia(ctx: DimenCallContext): Float = this.toDynamicPercentPx(ctx, DpQualifier.WIDTH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.pwdpLh(ctx: DimenCallContext): Float = this.toDynamicPercentPx(ctx, DpQualifier.WIDTH, Inverter.PW_TO_LH)
fun Number.pwdpLha(ctx: DimenCallContext): Float = this.toDynamicPercentPx(ctx, DpQualifier.WIDTH, Inverter.PW_TO_LH, applyAspectRatio = true)
fun Number.pwdpLhi(ctx: DimenCallContext): Float = this.toDynamicPercentPx(ctx, DpQualifier.WIDTH, Inverter.PW_TO_LH, ignoreMultiWindows = true)
fun Number.pwdpLhia(ctx: DimenCallContext): Float = this.toDynamicPercentPx(ctx, DpQualifier.WIDTH, Inverter.PW_TO_LH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.pwdpPh(ctx: DimenCallContext): Float = this.toDynamicPercentPx(ctx, DpQualifier.WIDTH, Inverter.LW_TO_PH)
fun Number.pwdpPha(ctx: DimenCallContext): Float = this.toDynamicPercentPx(ctx, DpQualifier.WIDTH, Inverter.LW_TO_PH, applyAspectRatio = true)
fun Number.pwdpPhi(ctx: DimenCallContext): Float = this.toDynamicPercentPx(ctx, DpQualifier.WIDTH, Inverter.LW_TO_PH, ignoreMultiWindows = true)
fun Number.pwdpPhia(ctx: DimenCallContext): Float = this.toDynamicPercentPx(ctx, DpQualifier.WIDTH, Inverter.LW_TO_PH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.psdpQualifier(ctx: DimenCallContext, qualifiedValue: Number, qualifierType: DpQualifier, qualifierValue: Number, finalQualifierResolver: DpQualifier? = null, ignoreMultiWindows: Boolean = false, applyAspectRatio: Boolean = false, customSensitivityK: Float? = null): Float {
    val metrics = ctx.screenMetrics
    val qualifierMatch = getQualifierValue(qualifierType, metrics) >= qualifierValue.toFloat()
    return if (qualifierMatch) {
        qualifiedValue.toDynamicPercentPx(ctx, finalQualifierResolver ?: DpQualifier.SMALL_WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    } else {
        this.toDynamicPercentPx(ctx, DpQualifier.SMALL_WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    }
}
 ...
 * é >= [qualifierValue], usa [qualifiedValue] no lugar.
 */
fun Number.phdpQualifier(ctx: DimenCallContext, qualifiedValue: Number, qualifierType: DpQualifier, qualifierValue: Number, finalQualifierResolver: DpQualifier? = null, ignoreMultiWindows: Boolean = false, applyAspectRatio: Boolean = false, customSensitivityK: Float? = null): Float {
    val metrics = ctx.screenMetrics
    val qualifierMatch = getQualifierValue(qualifierType, metrics) >= qualifierValue.toFloat()
    return if (qualifierMatch) {
        qualifiedValue.toDynamicPercentPx(ctx, finalQualifierResolver ?: DpQualifier.HEIGHT, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    } else {
        this.toDynamicPercentPx(ctx, DpQualifier.HEIGHT, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    }
}
 ...
 * é >= [qualifierValue], usa [qualifiedValue] no lugar.
 */
fun Number.pwdpQualifier(ctx: DimenCallContext, qualifiedValue: Number, qualifierType: DpQualifier, qualifierValue: Number, finalQualifierResolver: DpQualifier? = null, ignoreMultiWindows: Boolean = false, applyAspectRatio: Boolean = false, customSensitivityK: Float? = null): Float {
    val metrics = ctx.screenMetrics
    val qualifierMatch = getQualifierValue(qualifierType, metrics) >= qualifierValue.toFloat()
    return if (qualifierMatch) {
        qualifiedValue.toDynamicPercentPx(ctx, finalQualifierResolver ?: DpQualifier.WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    } else {
        this.toDynamicPercentPx(ctx, DpQualifier.WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    }
}
 ...
 */
fun Number.psdpScreen(ctx: DimenCallContext, screenValue: Number, uiModeType: UiModeType, qualifierType: DpQualifier, qualifierValue: Number, finalQualifierResolver: DpQualifier? = null, ignoreMultiWindows: Boolean = false, applyAspectRatio: Boolean = false, customSensitivityK: Float? = null): Float {
    val metrics = ctx.screenMetrics
    val currentUiModeType = ctx.currentUiMode()
    val uiModeMatch = currentUiModeType == uiModeType
    val qualifierMatch = getQualifierValue(qualifierType, metrics) >= qualifierValue.toFloat()
    return if (uiModeMatch && qualifierMatch) {
        screenValue.toDynamicPercentPx(ctx, finalQualifierResolver ?: DpQualifier.SMALL_WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    } else {
        this.toDynamicPercentPx(ctx, DpQualifier.SMALL_WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    }
}
 ...
 * a métrica de tela para [qualifierType] é >= [qualifierValue], usa [screenValue] no lugar.
 */
fun Number.phdpScreen(ctx: DimenCallContext, screenValue: Number, uiModeType: UiModeType, qualifierType: DpQualifier, qualifierValue: Number, finalQualifierResolver: DpQualifier? = null, ignoreMultiWindows: Boolean = false, applyAspectRatio: Boolean = false, customSensitivityK: Float? = null): Float {
    val metrics = ctx.screenMetrics
    val currentUiModeType = ctx.currentUiMode()
    val uiModeMatch = currentUiModeType == uiModeType
    val qualifierMatch = getQualifierValue(qualifierType, metrics) >= qualifierValue.toFloat()
    return if (uiModeMatch && qualifierMatch) {
        screenValue.toDynamicPercentPx(ctx, finalQualifierResolver ?: DpQualifier.HEIGHT, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    } else {
        this.toDynamicPercentPx(ctx, DpQualifier.HEIGHT, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    }
}
 ...
 * a métrica de tela para [qualifierType] é >= [qualifierValue], usa [screenValue] no lugar.
 */
fun Number.pwdpScreen(ctx: DimenCallContext, screenValue: Number, uiModeType: UiModeType, qualifierType: DpQualifier, qualifierValue: Number, finalQualifierResolver: DpQualifier? = null, ignoreMultiWindows: Boolean = false, applyAspectRatio: Boolean = false, customSensitivityK: Float? = null): Float {
    val metrics = ctx.screenMetrics
    val currentUiModeType = ctx.currentUiMode()
    val uiModeMatch = currentUiModeType == uiModeType
    val qualifierMatch = getQualifierValue(qualifierType, metrics) >= qualifierValue.toFloat()
    return if (uiModeMatch && qualifierMatch) {
        screenValue.toDynamicPercentPx(ctx, finalQualifierResolver ?: DpQualifier.WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    } else {
        this.toDynamicPercentPx(ctx, DpQualifier.WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    }
}
...
fun Number.toDynamicPercentPx(
    ...
    return DimenCache.getOrPut(cacheKey, ctx.cachePersistence) {
        val scaledDp = calculatePercentDp(base, metrics, qualifier, inverter, ignoreMultiWindows, applyAspectRatio, customSensitivityK, ctx)
        scaledDp * density
    }
}
...
fun Number.toDynamicPercentDp(
    ...
    return DimenCache.getOrPut(cacheKey, ctx.cachePersistence) {
        calculatePercentDp(base, metrics, qualifier, inverter, ignoreMultiWindows, applyAspectRatio, customSensitivityK, ctx)
    }
}