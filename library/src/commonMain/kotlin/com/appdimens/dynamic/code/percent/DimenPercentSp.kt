...
object DimenPercentSp {
     ...
     */
    @JvmStatic
    fun pssp(ctx: DimenCallContext, value: Int): Float = value.pssp(ctx)
     ...
     */
    @JvmStatic
    fun phsp(ctx: DimenCallContext, value: Int): Float = value.phsp(ctx)
     ...
     */
    @JvmStatic
    fun pwsp(ctx: DimenCallContext, value: Int): Float = value.pwsp(ctx)
    ...
    ): Float = value.toDynamicPercentSpPx(ctx, qualifier, fontScale, inverter, ignoreMultiWindows, applyAspectRatio, customSensitivityK)
    ...
    fun getDimensionInSp(
        ...
        applyAspectRatio: Boolean = false,
        customSensitivityK: Float? = null
    ): Float = value.toDynamicPercentSp(ctx, qualifier, fontScale, inverter, ignoreMultiWindows, applyAspectRatio, customSensitivityK)
