...
object DimenFillSp {
     ...
     */
    @JvmStatic
    fun flssp(ctx: DimenCallContext, value: Int): Float = value.flssp(ctx)
     ...
     */
    @JvmStatic
    fun flhsp(ctx: DimenCallContext, value: Int): Float = value.flhsp(ctx)
     ...
     */
    @JvmStatic
    fun flwsp(ctx: DimenCallContext, value: Int): Float = value.flwsp(ctx)
    ...
    ): Float = value.toDynamicFillSpPx(ctx, qualifier, fontScale, inverter, ignoreMultiWindows, applyAspectRatio, customSensitivityK)
    ...
    fun getDimensionInSp(
        ...
        applyAspectRatio: Boolean = false,
        customSensitivityK: Float? = null
    ): Float = value.toDynamicFillSp(ctx, qualifier, fontScale, inverter, ignoreMultiWindows, applyAspectRatio, customSensitivityK)
