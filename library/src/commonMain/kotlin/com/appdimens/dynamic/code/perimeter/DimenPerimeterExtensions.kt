...
fun Number.prsdpRotate(
    ...
    return if (isTargetOrientation) {
        rotationValue.toDynamicPerimeterPx(ctx, finalQualifierResolver, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    } else {
        this.toDynamicPerimeterPx(ctx, DpQualifier.SMALL_WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    }
}
...
fun Number.prhdpRotate(
    ...
    return if (isTargetOrientation) {
        ...
        this.toDynamicPerimeterPx(ctx, DpQualifier.HEIGHT, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    }
}
...
fun Number.prwdpRotate(
    ...
    return if (isTargetOrientation) {
        ...
        this.toDynamicPerimeterPx(ctx, DpQualifier.WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    }
}
...
fun Number.prsdpMode(
    ...
    return if (currentUiModeType == uiModeType) {
        modeValue.toDynamicPerimeterPx(ctx, finalQualifierResolver ?: DpQualifier.SMALL_WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    } else {
        this.toDynamicPerimeterPx(ctx, DpQualifier.SMALL_WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    }
}
...
fun Number.prhdpMode(
    ...
    return if (currentUiModeType == uiModeType) {
        modeValue.toDynamicPerimeterPx(ctx, finalQualifierResolver ?: DpQualifier.HEIGHT, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    } else {
        this.toDynamicPerimeterPx(ctx, DpQualifier.HEIGHT, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    }
}
...
fun Number.prwdpMode(
    ...
    val currentUiModeType = ctx.currentUiMode()
    return if (currentUiModeType == uiModeType) {
        modeValue.toDynamicPerimeterPx(ctx, finalQualifierResolver ?: DpQualifier.WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    } else {
        this.toDynamicPerimeterPx(ctx, DpQualifier.WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    }
}
 ...
 */
fun Number.prsdp(ctx: DimenCallContext): Float = this.toDynamicPerimeterPx(ctx, DpQualifier.SMALL_WIDTH)
fun Number.prsdpa(ctx: DimenCallContext): Float = this.toDynamicPerimeterPx(ctx, DpQualifier.SMALL_WIDTH, applyAspectRatio = true)
fun Number.prsdpi(ctx: DimenCallContext): Float = this.toDynamicPerimeterPx(ctx, DpQualifier.SMALL_WIDTH, ignoreMultiWindows = true)
fun Number.prsdpia(ctx: DimenCallContext): Float = this.toDynamicPerimeterPx(ctx, DpQualifier.SMALL_WIDTH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.prsdpPh(ctx: DimenCallContext): Float = this.toDynamicPerimeterPx(ctx, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PH)
fun Number.prsdpPha(ctx: DimenCallContext): Float = this.toDynamicPerimeterPx(ctx, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PH, applyAspectRatio = true)
fun Number.prsdpPhi(ctx: DimenCallContext): Float = this.toDynamicPerimeterPx(ctx, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PH, ignoreMultiWindows = true)
fun Number.prsdpPhia(ctx: DimenCallContext): Float = this.toDynamicPerimeterPx(ctx, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.prsdpLh(ctx: DimenCallContext): Float = this.toDynamicPerimeterPx(ctx, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LH)
fun Number.prsdpLha(ctx: DimenCallContext): Float = this.toDynamicPerimeterPx(ctx, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LH, applyAspectRatio = true)
fun Number.prsdpLhi(ctx: DimenCallContext): Float = this.toDynamicPerimeterPx(ctx, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LH, ignoreMultiWindows = true)
fun Number.prsdpLhia(ctx: DimenCallContext): Float = this.toDynamicPerimeterPx(ctx, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.prsdpPw(ctx: DimenCallContext): Float = this.toDynamicPerimeterPx(ctx, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PW)
fun Number.prsdpPwa(ctx: DimenCallContext): Float = this.toDynamicPerimeterPx(ctx, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PW, applyAspectRatio = true)
fun Number.prsdpPwi(ctx: DimenCallContext): Float = this.toDynamicPerimeterPx(ctx, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PW, ignoreMultiWindows = true)
fun Number.prsdpPwia(ctx: DimenCallContext): Float = this.toDynamicPerimeterPx(ctx, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PW, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.prsdpLw(ctx: DimenCallContext): Float = this.toDynamicPerimeterPx(ctx, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LW)
fun Number.prsdpLwa(ctx: DimenCallContext): Float = this.toDynamicPerimeterPx(ctx, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LW, applyAspectRatio = true)
fun Number.prsdpLwi(ctx: DimenCallContext): Float = this.toDynamicPerimeterPx(ctx, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LW, ignoreMultiWindows = true)
fun Number.prsdpLwia(ctx: DimenCallContext): Float = this.toDynamicPerimeterPx(ctx, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LW, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.prhdp(ctx: DimenCallContext): Float = this.toDynamicPerimeterPx(ctx, DpQualifier.HEIGHT)
fun Number.prhdpa(ctx: DimenCallContext): Float = this.toDynamicPerimeterPx(ctx, DpQualifier.HEIGHT, applyAspectRatio = true)
fun Number.prhdpi(ctx: DimenCallContext): Float = this.toDynamicPerimeterPx(ctx, DpQualifier.HEIGHT, ignoreMultiWindows = true)
fun Number.prhdpia(ctx: DimenCallContext): Float = this.toDynamicPerimeterPx(ctx, DpQualifier.HEIGHT, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.prhdpLw(ctx: DimenCallContext): Float = this.toDynamicPerimeterPx(ctx, DpQualifier.HEIGHT, Inverter.PH_TO_LW)
fun Number.prhdpLwa(ctx: DimenCallContext): Float = this.toDynamicPerimeterPx(ctx, DpQualifier.HEIGHT, Inverter.PH_TO_LW, applyAspectRatio = true)
fun Number.prhdpLwi(ctx: DimenCallContext): Float = this.toDynamicPerimeterPx(ctx, DpQualifier.HEIGHT, Inverter.PH_TO_LW, ignoreMultiWindows = true)
fun Number.prhdpLwia(ctx: DimenCallContext): Float = this.toDynamicPerimeterPx(ctx, DpQualifier.HEIGHT, Inverter.PH_TO_LW, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.prhdpPw(ctx: DimenCallContext): Float = this.toDynamicPerimeterPx(ctx, DpQualifier.HEIGHT, Inverter.LH_TO_PW)
fun Number.prhdpPwa(ctx: DimenCallContext): Float = this.toDynamicPerimeterPx(ctx, DpQualifier.HEIGHT, Inverter.LH_TO_PW, applyAspectRatio = true)
fun Number.prhdpPwi(ctx: DimenCallContext): Float = this.toDynamicPerimeterPx(ctx, DpQualifier.HEIGHT, Inverter.LH_TO_PW, ignoreMultiWindows = true)
fun Number.prhdpPwia(ctx: DimenCallContext): Float = this.toDynamicPerimeterPx(ctx, DpQualifier.HEIGHT, Inverter.LH_TO_PW, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.prwdp(ctx: DimenCallContext): Float = this.toDynamicPerimeterPx(ctx, DpQualifier.WIDTH)
fun Number.prwdpa(ctx: DimenCallContext): Float = this.toDynamicPerimeterPx(ctx, DpQualifier.WIDTH, applyAspectRatio = true)
fun Number.prwdpi(ctx: DimenCallContext): Float = this.toDynamicPerimeterPx(ctx, DpQualifier.WIDTH, ignoreMultiWindows = true)
fun Number.prwdpia(ctx: DimenCallContext): Float = this.toDynamicPerimeterPx(ctx, DpQualifier.WIDTH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.prwdpLh(ctx: DimenCallContext): Float = this.toDynamicPerimeterPx(ctx, DpQualifier.WIDTH, Inverter.PW_TO_LH)
fun Number.prwdpLha(ctx: DimenCallContext): Float = this.toDynamicPerimeterPx(ctx, DpQualifier.WIDTH, Inverter.PW_TO_LH, applyAspectRatio = true)
fun Number.prwdpLhi(ctx: DimenCallContext): Float = this.toDynamicPerimeterPx(ctx, DpQualifier.WIDTH, Inverter.PW_TO_LH, ignoreMultiWindows = true)
fun Number.prwdpLhia(ctx: DimenCallContext): Float = this.toDynamicPerimeterPx(ctx, DpQualifier.WIDTH, Inverter.PW_TO_LH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.prwdpPh(ctx: DimenCallContext): Float = this.toDynamicPerimeterPx(ctx, DpQualifier.WIDTH, Inverter.LW_TO_PH)
fun Number.prwdpPha(ctx: DimenCallContext): Float = this.toDynamicPerimeterPx(ctx, DpQualifier.WIDTH, Inverter.LW_TO_PH, applyAspectRatio = true)
fun Number.prwdpPhi(ctx: DimenCallContext): Float = this.toDynamicPerimeterPx(ctx, DpQualifier.WIDTH, Inverter.LW_TO_PH, ignoreMultiWindows = true)
fun Number.prwdpPhia(ctx: DimenCallContext): Float = this.toDynamicPerimeterPx(ctx, DpQualifier.WIDTH, Inverter.LW_TO_PH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.prsdpQualifier(ctx: DimenCallContext, qualifiedValue: Number, qualifierType: DpQualifier, qualifierValue: Number, finalQualifierResolver: DpQualifier? = null, ignoreMultiWindows: Boolean = false, applyAspectRatio: Boolean = false, customSensitivityK: Float? = null): Float {
    val metrics = ctx.screenMetrics
    val qualifierMatch = getQualifierValue(qualifierType, metrics) >= qualifierValue.toFloat()
    return if (qualifierMatch) {
        qualifiedValue.toDynamicPerimeterPx(ctx, finalQualifierResolver ?: DpQualifier.SMALL_WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    } else {
        this.toDynamicPerimeterPx(ctx, DpQualifier.SMALL_WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    }
}
 ...
 * é >= [qualifierValue], usa [qualifiedValue] no lugar.
 */
fun Number.prhdpQualifier(ctx: DimenCallContext, qualifiedValue: Number, qualifierType: DpQualifier, qualifierValue: Number, finalQualifierResolver: DpQualifier? = null, ignoreMultiWindows: Boolean = false, applyAspectRatio: Boolean = false, customSensitivityK: Float? = null): Float {
    val metrics = ctx.screenMetrics
    val qualifierMatch = getQualifierValue(qualifierType, metrics) >= qualifierValue.toFloat()
    return if (qualifierMatch) {
        qualifiedValue.toDynamicPerimeterPx(ctx, finalQualifierResolver ?: DpQualifier.HEIGHT, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    } else {
        this.toDynamicPerimeterPx(ctx, DpQualifier.HEIGHT, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    }
}
 ...
 * é >= [qualifierValue], usa [qualifiedValue] no lugar.
 */
fun Number.prwdpQualifier(ctx: DimenCallContext, qualifiedValue: Number, qualifierType: DpQualifier, qualifierValue: Number, finalQualifierResolver: DpQualifier? = null, ignoreMultiWindows: Boolean = false, applyAspectRatio: Boolean = false, customSensitivityK: Float? = null): Float {
    val metrics = ctx.screenMetrics
    val qualifierMatch = getQualifierValue(qualifierType, metrics) >= qualifierValue.toFloat()
    return if (qualifierMatch) {
        qualifiedValue.toDynamicPerimeterPx(ctx, finalQualifierResolver ?: DpQualifier.WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    } else {
        this.toDynamicPerimeterPx(ctx, DpQualifier.WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    }
}
 ...
 */
fun Number.prsdpScreen(ctx: DimenCallContext, screenValue: Number, uiModeType: UiModeType, qualifierType: DpQualifier, qualifierValue: Number, finalQualifierResolver: DpQualifier? = null, ignoreMultiWindows: Boolean = false, applyAspectRatio: Boolean = false, customSensitivityK: Float? = null): Float {
    val metrics = ctx.screenMetrics
    val currentUiModeType = ctx.currentUiMode()
    val uiModeMatch = currentUiModeType == uiModeType
    val qualifierMatch = getQualifierValue(qualifierType, metrics) >= qualifierValue.toFloat()
    return if (uiModeMatch && qualifierMatch) {
        screenValue.toDynamicPerimeterPx(ctx, finalQualifierResolver ?: DpQualifier.SMALL_WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    } else {
        this.toDynamicPerimeterPx(ctx, DpQualifier.SMALL_WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    }
}
 ...
 * a métrica de tela para [qualifierType] é >= [qualifierValue], usa [screenValue] no lugar.
 */
fun Number.prhdpScreen(ctx: DimenCallContext, screenValue: Number, uiModeType: UiModeType, qualifierType: DpQualifier, qualifierValue: Number, finalQualifierResolver: DpQualifier? = null, ignoreMultiWindows: Boolean = false, applyAspectRatio: Boolean = false, customSensitivityK: Float? = null): Float {
    val metrics = ctx.screenMetrics
    val currentUiModeType = ctx.currentUiMode()
    val uiModeMatch = currentUiModeType == uiModeType
    val qualifierMatch = getQualifierValue(qualifierType, metrics) >= qualifierValue.toFloat()
    return if (uiModeMatch && qualifierMatch) {
        screenValue.toDynamicPerimeterPx(ctx, finalQualifierResolver ?: DpQualifier.HEIGHT, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    } else {
        this.toDynamicPerimeterPx(ctx, DpQualifier.HEIGHT, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    }
}
 ...
 * a métrica de tela para [qualifierType] é >= [qualifierValue], usa [screenValue] no lugar.
 */
fun Number.prwdpScreen(ctx: DimenCallContext, screenValue: Number, uiModeType: UiModeType, qualifierType: DpQualifier, qualifierValue: Number, finalQualifierResolver: DpQualifier? = null, ignoreMultiWindows: Boolean = false, applyAspectRatio: Boolean = false, customSensitivityK: Float? = null): Float {
    val metrics = ctx.screenMetrics
    val currentUiModeType = ctx.currentUiMode()
    val uiModeMatch = currentUiModeType == uiModeType
    val qualifierMatch = getQualifierValue(qualifierType, metrics) >= qualifierValue.toFloat()
    return if (uiModeMatch && qualifierMatch) {
        screenValue.toDynamicPerimeterPx(ctx, finalQualifierResolver ?: DpQualifier.WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    } else {
        this.toDynamicPerimeterPx(ctx, DpQualifier.WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    }
}
...
fun Number.toDynamicPerimeterPx(
    ...
    return DimenCache.getOrPut(cacheKey, ctx.cachePersistence) {
        val scaledDp = calculatePerimeterDp(base, metrics, qualifier, inverter, ignoreMultiWindows, applyAspectRatio, customSensitivityK, ctx)
        scaledDp * density
    }
}
...
fun Number.toDynamicPerimeterDp(
    ...
    return DimenCache.getOrPut(cacheKey, ctx.cachePersistence) {
        calculatePerimeterDp(base, metrics, qualifier, inverter, ignoreMultiWindows, applyAspectRatio, customSensitivityK, ctx)
    }
}