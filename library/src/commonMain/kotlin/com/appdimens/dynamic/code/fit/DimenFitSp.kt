...
object DimenFitSp {
     ...
     */
    @JvmStatic
    fun ftssp(ctx: DimenCallContext, value: Int): Float = value.ftssp(ctx)
     ...
     */
    @JvmStatic
    fun fthsp(ctx: DimenCallContext, value: Int): Float = value.fthsp(ctx)
     ...
     */
    @JvmStatic
    fun ftwsp(ctx: DimenCallContext, value: Int): Float = value.ftwsp(ctx)
    ...
    ): Float = value.toDynamicFitSpPx(ctx, qualifier, fontScale, inverter, ignoreMultiWindows, applyAspectRatio, customSensitivityK)
    ...
    fun getDimensionInSp(
        ...
        applyAspectRatio: Boolean = false,
        customSensitivityK: Float? = null
    ): Float = value.toDynamicFitSp(ctx, qualifier, fontScale, inverter, ignoreMultiWindows, applyAspectRatio, customSensitivityK)
