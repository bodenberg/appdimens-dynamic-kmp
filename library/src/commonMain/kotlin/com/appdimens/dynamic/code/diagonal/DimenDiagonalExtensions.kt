...
fun Number.dgsdpRotate(
    ...
    return if (isTargetOrientation) {
        rotationValue.toDynamicDiagonalPx(ctx, finalQualifierResolver, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    } else {
        this.toDynamicDiagonalPx(ctx, DpQualifier.SMALL_WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    }
}
...
fun Number.dghdpRotate(
    ...
    return if (isTargetOrientation) {
        ...
        this.toDynamicDiagonalPx(ctx, DpQualifier.HEIGHT, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    }
}
...
fun Number.dgwdpRotate(
    ...
    return if (isTargetOrientation) {
        ...
        this.toDynamicDiagonalPx(ctx, DpQualifier.WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    }
}
...
fun Number.dgsdpMode(
    ...
    return if (currentUiModeType == uiModeType) {
        modeValue.toDynamicDiagonalPx(ctx, finalQualifierResolver ?: DpQualifier.SMALL_WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    } else {
        this.toDynamicDiagonalPx(ctx, DpQualifier.SMALL_WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    }
}
...
fun Number.dghdpMode(
    ...
    return if (currentUiModeType == uiModeType) {
        modeValue.toDynamicDiagonalPx(ctx, finalQualifierResolver ?: DpQualifier.HEIGHT, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    } else {
        this.toDynamicDiagonalPx(ctx, DpQualifier.HEIGHT, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    }
}
...
fun Number.dgwdpMode(
    ...
    val currentUiModeType = ctx.currentUiMode()
    return if (currentUiModeType == uiModeType) {
        modeValue.toDynamicDiagonalPx(ctx, finalQualifierResolver ?: DpQualifier.WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    } else {
        this.toDynamicDiagonalPx(ctx, DpQualifier.WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    }
}
 ...
 */
fun Number.dgsdp(ctx: DimenCallContext): Float = this.toDynamicDiagonalPx(ctx, DpQualifier.SMALL_WIDTH)
fun Number.dgsdpa(ctx: DimenCallContext): Float = this.toDynamicDiagonalPx(ctx, DpQualifier.SMALL_WIDTH, applyAspectRatio = true)
fun Number.dgsdpi(ctx: DimenCallContext): Float = this.toDynamicDiagonalPx(ctx, DpQualifier.SMALL_WIDTH, ignoreMultiWindows = true)
fun Number.dgsdpia(ctx: DimenCallContext): Float = this.toDynamicDiagonalPx(ctx, DpQualifier.SMALL_WIDTH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.dgsdpPh(ctx: DimenCallContext): Float = this.toDynamicDiagonalPx(ctx, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PH)
fun Number.dgsdpPha(ctx: DimenCallContext): Float = this.toDynamicDiagonalPx(ctx, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PH, applyAspectRatio = true)
fun Number.dgsdpPhi(ctx: DimenCallContext): Float = this.toDynamicDiagonalPx(ctx, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PH, ignoreMultiWindows = true)
fun Number.dgsdpPhia(ctx: DimenCallContext): Float = this.toDynamicDiagonalPx(ctx, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.dgsdpLh(ctx: DimenCallContext): Float = this.toDynamicDiagonalPx(ctx, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LH)
fun Number.dgsdpLha(ctx: DimenCallContext): Float = this.toDynamicDiagonalPx(ctx, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LH, applyAspectRatio = true)
fun Number.dgsdpLhi(ctx: DimenCallContext): Float = this.toDynamicDiagonalPx(ctx, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LH, ignoreMultiWindows = true)
fun Number.dgsdpLhia(ctx: DimenCallContext): Float = this.toDynamicDiagonalPx(ctx, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.dgsdpPw(ctx: DimenCallContext): Float = this.toDynamicDiagonalPx(ctx, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PW)
fun Number.dgsdpPwa(ctx: DimenCallContext): Float = this.toDynamicDiagonalPx(ctx, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PW, applyAspectRatio = true)
fun Number.dgsdpPwi(ctx: DimenCallContext): Float = this.toDynamicDiagonalPx(ctx, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PW, ignoreMultiWindows = true)
fun Number.dgsdpPwia(ctx: DimenCallContext): Float = this.toDynamicDiagonalPx(ctx, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_PW, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.dgsdpLw(ctx: DimenCallContext): Float = this.toDynamicDiagonalPx(ctx, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LW)
fun Number.dgsdpLwa(ctx: DimenCallContext): Float = this.toDynamicDiagonalPx(ctx, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LW, applyAspectRatio = true)
fun Number.dgsdpLwi(ctx: DimenCallContext): Float = this.toDynamicDiagonalPx(ctx, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LW, ignoreMultiWindows = true)
fun Number.dgsdpLwia(ctx: DimenCallContext): Float = this.toDynamicDiagonalPx(ctx, DpQualifier.SMALL_WIDTH, Inverter.SW_TO_LW, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.dghdp(ctx: DimenCallContext): Float = this.toDynamicDiagonalPx(ctx, DpQualifier.HEIGHT)
fun Number.dghdpa(ctx: DimenCallContext): Float = this.toDynamicDiagonalPx(ctx, DpQualifier.HEIGHT, applyAspectRatio = true)
fun Number.dghdpi(ctx: DimenCallContext): Float = this.toDynamicDiagonalPx(ctx, DpQualifier.HEIGHT, ignoreMultiWindows = true)
fun Number.dghdpia(ctx: DimenCallContext): Float = this.toDynamicDiagonalPx(ctx, DpQualifier.HEIGHT, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.dghdpLw(ctx: DimenCallContext): Float = this.toDynamicDiagonalPx(ctx, DpQualifier.HEIGHT, Inverter.PH_TO_LW)
fun Number.dghdpLwa(ctx: DimenCallContext): Float = this.toDynamicDiagonalPx(ctx, DpQualifier.HEIGHT, Inverter.PH_TO_LW, applyAspectRatio = true)
fun Number.dghdpLwi(ctx: DimenCallContext): Float = this.toDynamicDiagonalPx(ctx, DpQualifier.HEIGHT, Inverter.PH_TO_LW, ignoreMultiWindows = true)
fun Number.dghdpLwia(ctx: DimenCallContext): Float = this.toDynamicDiagonalPx(ctx, DpQualifier.HEIGHT, Inverter.PH_TO_LW, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.dghdpPw(ctx: DimenCallContext): Float = this.toDynamicDiagonalPx(ctx, DpQualifier.HEIGHT, Inverter.LH_TO_PW)
fun Number.dghdpPwa(ctx: DimenCallContext): Float = this.toDynamicDiagonalPx(ctx, DpQualifier.HEIGHT, Inverter.LH_TO_PW, applyAspectRatio = true)
fun Number.dghdpPwi(ctx: DimenCallContext): Float = this.toDynamicDiagonalPx(ctx, DpQualifier.HEIGHT, Inverter.LH_TO_PW, ignoreMultiWindows = true)
fun Number.dghdpPwia(ctx: DimenCallContext): Float = this.toDynamicDiagonalPx(ctx, DpQualifier.HEIGHT, Inverter.LH_TO_PW, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.dgwdp(ctx: DimenCallContext): Float = this.toDynamicDiagonalPx(ctx, DpQualifier.WIDTH)
fun Number.dgwdpa(ctx: DimenCallContext): Float = this.toDynamicDiagonalPx(ctx, DpQualifier.WIDTH, applyAspectRatio = true)
fun Number.dgwdpi(ctx: DimenCallContext): Float = this.toDynamicDiagonalPx(ctx, DpQualifier.WIDTH, ignoreMultiWindows = true)
fun Number.dgwdpia(ctx: DimenCallContext): Float = this.toDynamicDiagonalPx(ctx, DpQualifier.WIDTH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.dgwdpLh(ctx: DimenCallContext): Float = this.toDynamicDiagonalPx(ctx, DpQualifier.WIDTH, Inverter.PW_TO_LH)
fun Number.dgwdpLha(ctx: DimenCallContext): Float = this.toDynamicDiagonalPx(ctx, DpQualifier.WIDTH, Inverter.PW_TO_LH, applyAspectRatio = true)
fun Number.dgwdpLhi(ctx: DimenCallContext): Float = this.toDynamicDiagonalPx(ctx, DpQualifier.WIDTH, Inverter.PW_TO_LH, ignoreMultiWindows = true)
fun Number.dgwdpLhia(ctx: DimenCallContext): Float = this.toDynamicDiagonalPx(ctx, DpQualifier.WIDTH, Inverter.PW_TO_LH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.dgwdpPh(ctx: DimenCallContext): Float = this.toDynamicDiagonalPx(ctx, DpQualifier.WIDTH, Inverter.LW_TO_PH)
fun Number.dgwdpPha(ctx: DimenCallContext): Float = this.toDynamicDiagonalPx(ctx, DpQualifier.WIDTH, Inverter.LW_TO_PH, applyAspectRatio = true)
fun Number.dgwdpPhi(ctx: DimenCallContext): Float = this.toDynamicDiagonalPx(ctx, DpQualifier.WIDTH, Inverter.LW_TO_PH, ignoreMultiWindows = true)
fun Number.dgwdpPhia(ctx: DimenCallContext): Float = this.toDynamicDiagonalPx(ctx, DpQualifier.WIDTH, Inverter.LW_TO_PH, ignoreMultiWindows = true, applyAspectRatio = true)
 ...
 */
fun Number.dgsdpQualifier(ctx: DimenCallContext, qualifiedValue: Number, qualifierType: DpQualifier, qualifierValue: Number, finalQualifierResolver: DpQualifier? = null, ignoreMultiWindows: Boolean = false, applyAspectRatio: Boolean = false, customSensitivityK: Float? = null): Float {
    val metrics = ctx.screenMetrics
    val qualifierMatch = getQualifierValue(qualifierType, metrics) >= qualifierValue.toFloat()
    return if (qualifierMatch) {
        qualifiedValue.toDynamicDiagonalPx(ctx, finalQualifierResolver ?: DpQualifier.SMALL_WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    } else {
        this.toDynamicDiagonalPx(ctx, DpQualifier.SMALL_WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    }
}
 ...
 * é >= [qualifierValue], usa [qualifiedValue] no lugar.
 */
fun Number.dghdpQualifier(ctx: DimenCallContext, qualifiedValue: Number, qualifierType: DpQualifier, qualifierValue: Number, finalQualifierResolver: DpQualifier? = null, ignoreMultiWindows: Boolean = false, applyAspectRatio: Boolean = false, customSensitivityK: Float? = null): Float {
    val metrics = ctx.screenMetrics
    val qualifierMatch = getQualifierValue(qualifierType, metrics) >= qualifierValue.toFloat()
    return if (qualifierMatch) {
        qualifiedValue.toDynamicDiagonalPx(ctx, finalQualifierResolver ?: DpQualifier.HEIGHT, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    } else {
        this.toDynamicDiagonalPx(ctx, DpQualifier.HEIGHT, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    }
}
 ...
 * é >= [qualifierValue], usa [qualifiedValue] no lugar.
 */
fun Number.dgwdpQualifier(ctx: DimenCallContext, qualifiedValue: Number, qualifierType: DpQualifier, qualifierValue: Number, finalQualifierResolver: DpQualifier? = null, ignoreMultiWindows: Boolean = false, applyAspectRatio: Boolean = false, customSensitivityK: Float? = null): Float {
    val metrics = ctx.screenMetrics
    val qualifierMatch = getQualifierValue(qualifierType, metrics) >= qualifierValue.toFloat()
    return if (qualifierMatch) {
        qualifiedValue.toDynamicDiagonalPx(ctx, finalQualifierResolver ?: DpQualifier.WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    } else {
        this.toDynamicDiagonalPx(ctx, DpQualifier.WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    }
}
 ...
 */
fun Number.dgsdpScreen(ctx: DimenCallContext, screenValue: Number, uiModeType: UiModeType, qualifierType: DpQualifier, qualifierValue: Number, finalQualifierResolver: DpQualifier? = null, ignoreMultiWindows: Boolean = false, applyAspectRatio: Boolean = false, customSensitivityK: Float? = null): Float {
    val metrics = ctx.screenMetrics
    val currentUiModeType = ctx.currentUiMode()
    val uiModeMatch = currentUiModeType == uiModeType
    val qualifierMatch = getQualifierValue(qualifierType, metrics) >= qualifierValue.toFloat()
    return if (uiModeMatch && qualifierMatch) {
        screenValue.toDynamicDiagonalPx(ctx, finalQualifierResolver ?: DpQualifier.SMALL_WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    } else {
        this.toDynamicDiagonalPx(ctx, DpQualifier.SMALL_WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    }
}
 ...
 * a métrica de tela para [qualifierType] é >= [qualifierValue], usa [screenValue] no lugar.
 */
fun Number.dghdpScreen(ctx: DimenCallContext, screenValue: Number, uiModeType: UiModeType, qualifierType: DpQualifier, qualifierValue: Number, finalQualifierResolver: DpQualifier? = null, ignoreMultiWindows: Boolean = false, applyAspectRatio: Boolean = false, customSensitivityK: Float? = null): Float {
    val metrics = ctx.screenMetrics
    val currentUiModeType = ctx.currentUiMode()
    val uiModeMatch = currentUiModeType == uiModeType
    val qualifierMatch = getQualifierValue(qualifierType, metrics) >= qualifierValue.toFloat()
    return if (uiModeMatch && qualifierMatch) {
        screenValue.toDynamicDiagonalPx(ctx, finalQualifierResolver ?: DpQualifier.HEIGHT, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    } else {
        this.toDynamicDiagonalPx(ctx, DpQualifier.HEIGHT, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    }
}
 ...
 * a métrica de tela para [qualifierType] é >= [qualifierValue], usa [screenValue] no lugar.
 */
fun Number.dgwdpScreen(ctx: DimenCallContext, screenValue: Number, uiModeType: UiModeType, qualifierType: DpQualifier, qualifierValue: Number, finalQualifierResolver: DpQualifier? = null, ignoreMultiWindows: Boolean = false, applyAspectRatio: Boolean = false, customSensitivityK: Float? = null): Float {
    val metrics = ctx.screenMetrics
    val currentUiModeType = ctx.currentUiMode()
    val uiModeMatch = currentUiModeType == uiModeType
    val qualifierMatch = getQualifierValue(qualifierType, metrics) >= qualifierValue.toFloat()
    return if (uiModeMatch && qualifierMatch) {
        screenValue.toDynamicDiagonalPx(ctx, finalQualifierResolver ?: DpQualifier.WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    } else {
        this.toDynamicDiagonalPx(ctx, DpQualifier.WIDTH, ignoreMultiWindows = ignoreMultiWindows, applyAspectRatio = applyAspectRatio, customSensitivityK = customSensitivityK)
    }
}
...
fun Number.toDynamicDiagonalPx(
    ...
    return DimenCache.getOrPut(cacheKey, ctx.cachePersistence) {
        val scaledDp = calculateDiagonalDp(base, metrics, qualifier, inverter, ignoreMultiWindows, applyAspectRatio, customSensitivityK, ctx)
        scaledDp * density
    }
}
...
fun Number.toDynamicDiagonalDp(
    ...
    return DimenCache.getOrPut(cacheKey, ctx.cachePersistence) {
        calculateDiagonalDp(base, metrics, qualifier, inverter, ignoreMultiWindows, applyAspectRatio, customSensitivityK, ctx)
    }
}